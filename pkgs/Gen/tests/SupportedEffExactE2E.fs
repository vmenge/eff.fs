...
module SupportedEffExactE2E =
  ...
  let tests =
    testSequenced <| testList "SupportedEffExactE2E" [
      testTask "supported Eff exact fixture builds with generated modules in the same build" {
      ...
      testTask "supported Eff exact generated output uses direct modules and flattens nested Eff returns" {
        let! result = builtFixture.Value
      ...
      testTask "supported Eff exact fixture executes generated modules at runtime" {
